...
exports.detectBrave = void 0;
var interfaces_1 = require("../../utils/interfaces");
var detectBrave = function () { return __awaiter(void 0, void 0, void 0, function () {
    var braveNavigator, braveClues, likeBrave, isBrave, mode, brave;
    return __generator(this, function (_a) {
        braveNavigator = navigator;
        if (typeof braveNavigator === 'undefined' || braveNavigator === null)
            ...
            likeBrave = braveClues.includes(true);
            isBrave = !braveClues.includes(false);
            mode = -1;
            if (likeBrave) {
            ...
            brave = {
                ...
                isBrave: isBrave,
                mode: mode,
                braveClues: braveClues
            };
            return [2 /*return*/, (0, interfaces_1.resolveComponent)(0, { brave: brave })];
        }
        return [2 /*return*/];
    });
}); };
exports.detectBrave = detectBrave;
